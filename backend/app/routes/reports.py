...
def _generate_form_b_excel(payroll, est, config, entries, rows, head_map):
    ...
    for idx, row_data in enumerate(rows):
        ...
        data_cells = [
            ...
            ('K', round(row_data['ot_amount'], 2), right_align, data_font, None),
            ...
            ('O', round(row_data['gross'], 2), right_align, gross_font, gross_fill),
            ...
            ('X', round(row_data['net_pay'], 2), right_align, net_font, net_fill),
    ...
    total_cells = [
        ...
        ('X', round(totals['net_pay'], 2), right_align),
        ('Y', '', center),
        ('Z', '', center),
        ('AA', '', center),
    ]
